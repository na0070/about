...
<div class="h-100 center-me text-center">
    <div class="my-auto">
        <form action="includes/upload-helper.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea name="bio" id="bio" cols="30" row="10" placeholder="bio..." style="text-align: center;"></textarea>
            </div>
            <div class="form-group">
                <button type="submit" name="prof-submit" class="btn-outline-success btn-lg btn-block">upload info</button>
            </div>
        </form>
    </div>
</div>
